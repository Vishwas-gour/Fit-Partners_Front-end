...
import { FaSearch, FaPercent, FaWeightHanging, FaRupeeSign, FaTag, FaPalette, FaRuler, FaListUl, FaVenusMars, FaCubes, FaStar, FaTimes } from "react-icons/fa"
...
function Shoes() {
  ...
  return (
    <div className={` shoe-container ${isFilterOpen ? "filter-open" : ""}`}>
      ...
      {/* Toggle Button with react-icons */}
